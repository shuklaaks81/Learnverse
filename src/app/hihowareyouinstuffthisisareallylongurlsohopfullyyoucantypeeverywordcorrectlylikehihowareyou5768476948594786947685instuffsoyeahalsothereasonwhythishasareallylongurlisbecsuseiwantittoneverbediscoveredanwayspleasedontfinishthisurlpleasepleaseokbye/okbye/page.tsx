      ...
      <div className="relative z-10 min-h-screen flex items-center justify-center p-8">
        <div className="text-center max-w-4xl">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-8">
            ...
            <Link
              href="/hihowareyouinstuffthisisareallylongurlsohopfullyyoucantypeeverywordcorrectlylikehihowareyou5768476948594786947685instuffsoyeahalsothereasonwhythishasareallylongurlisbecsuseiwantittoneverbediscoveredanwayspleasedontfinishthisurlpleasepleaseokbye"
