...
export default function SecretUltraLongURLPage() {
  ...
  const urlLength = ''.length;

  useEffect(() => {
    unlockAchievement('ultrasecret');
        ...
        <div className="text-center max-w-5xl">
          ...
          <div className="bg-black bg-opacity-80 rounded-2xl p-8 mb-8 border-4 border-blue-400">
            ...
            <div className="text-sm md:text-base text-gray-300 font-mono break-all leading-relaxed">
              
            </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-8">
            ...
            <button
              onClick={() => {
                navigator.clipboard?.writeText('localhost:');
          ...
          <div className="mt-12 text-gray-400 text-sm">
            ...
            <p className="mt-4 text-xs text-gray-600">
              (Psst: You can also access this at /ultrasecret - the full URL was too long for the filesystem!)
            </p>
          </div>
        </div>
      </div>
